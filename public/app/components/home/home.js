    ...
    <div class="z3" id="aboutContainer" ng-if="$ctrl.about">
        ...
        <div ng-if="$ctrl.who" class="flex" id="mainDeveloperContainer">
            ...
            <div class="devContainer">
                ...
                <p class="developerBio">I'm a front-end developer, GIS Specialist, and data visualizer. I loved making sure this app provided an efficient access to data and aesthetic integrety.</p>
            </div>
            <div class="devContainer">
                ...
                <p class="developerBio">I'm a former teacher and lab analyst who has recently converted to the tech field. For this project, I had the most fun wiring up watson and the currency conversions.</p>
            </div>
            <div class="devContainer">
                ...
                <p class="developerBio">I’m a logistics manager turned web developer. For this project, I liked working on the ibm Watson translate api and adding css/styling to the functionality.</p>
            </div>
        </div>
    </div>

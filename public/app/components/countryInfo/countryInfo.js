...
.component('countryInfo', {
    ...
    <div>
        ...
        <button class="searchButton" ng-click="$ctrl.getCountryData($ctrl.countryInput); $ctrl.service.translatePhrases($ctrl.targetLanguage); $ctrl.$location.path('/explore')"> Explore </button>
        </div>
    </div> 
        `,
